...
const projects: Project[] = [
  ...
  { id: '3', name: 'LUMINA', desc: 'Makes it easier to find items or tools if someone needs them.', long: 'LUMINA is a goods procurement system at the community level to make it easier for residents to carry out their activities if they need goods or tools.', tags: ['Java', 'Spring Boot', 'Supabase'], year: 2026, color: 'bg-[var(--blue)]', image: '/images/portfolio-assets/lumina.png', linkLiveDemo: 'https://tanstack-start-app.lumina-apps.workers.dev/', linkSourceCode: '#', status: 'completed' },
  { id: '4', name: 'Rambutan Ripeness', desc: 'Analyze the maturity level of rambutan with 70.00% accuracy', long: 'Analyze the maturity level of rambutan using HSV and the KNN model with 250 datasets', tags: ['Python', 'KNN', 'HSV'], year: 2026, color: 'bg-[var(--blue)]', image: '/images/portfolio-assets/rambutan.png', linkLiveDemo: 'https://rambutan-ripeness.vercel.app/', linkSourceCode: '#', status: 'completed' },
]
